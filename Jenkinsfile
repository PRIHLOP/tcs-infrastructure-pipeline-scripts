...
node
{
 git "git@github.com:travelcommercesolutions/tcs-infrastructure-pipeline-scripts.git"
}

def upstreamRepoUrl = "https://github.com/travelcommercesolutions/tcs-infrastructure-pipeline-scripts.git"
